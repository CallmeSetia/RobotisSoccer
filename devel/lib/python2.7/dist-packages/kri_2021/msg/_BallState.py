...
"""autogenerated by genpy from kri_2021/BallState.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.bola_state,) = _get_struct_B().unpack(str[start:end])
      self.bola_state = bool(self.bola_state)
      start = end
      end += 4
