...
(cl:defclass <BolaKoordinat> (roslisp-msg-protocol:ros-message)
  ((x_bola
    :reader x_bola
    :initarg :x_bola
    :type cl:float
...
(cl:defclass BolaKoordinat (<BolaKoordinat>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <BolaKoordinat>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'BolaKoordinat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kri_2021-msg:<BolaKoordinat> is deprecated: use kri_2021-msg:BolaKoordinat instead.")))

(cl:ensure-generic-function 'x_bola-val :lambda-list '(m))
(cl:defmethod x_bola-val ((m <BolaKoordinat>))
...
(cl:defmethod y_bola-val ((m <BolaKoordinat>))
...
(cl:defmethod z_bola-val ((m <BolaKoordinat>))
...
(cl:defmethod x_pixel-val ((m <BolaKoordinat>))
...
(cl:defmethod y_pixel-val ((m <BolaKoordinat>))
...
(cl:defmethod radius-val ((m <BolaKoordinat>))
  ...
  (radius m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BolaKoordinat>) ostream)
  "Serializes a message object of type '<BolaKoordinat>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BolaKoordinat>) istream)
  "Deserializes a message object of type '<BolaKoordinat>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BolaKoordinat>)))
  "Returns string type for a message object of type '<BolaKoordinat>"
  "kri_2021/BolaKoordinat")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BolaKoordinat)))
  "Returns string type for a message object of type 'BolaKoordinat"
  "kri_2021/BolaKoordinat")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BolaKoordinat>)))
  "Returns md5sum for a message object of type '<BolaKoordinat>"
  "6c819dfe572dd654cecc1d700d834ad7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BolaKoordinat)))
  "Returns md5sum for a message object of type 'BolaKoordinat"
  "6c819dfe572dd654cecc1d700d834ad7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BolaKoordinat>)))
  "Returns full string definition for message of type '<BolaKoordinat>"
  (cl:format cl:nil "float32 x_bola~%float32 y_bola~%float32 z_bola~%int16 x_pixel~%int16 y_pixel~%int16 radius~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BolaKoordinat)))
  "Returns full string definition for message of type 'BolaKoordinat"
  (cl:format cl:nil "float32 x_bola~%float32 y_bola~%float32 z_bola~%int16 x_pixel~%int16 y_pixel~%int16 radius~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <BolaKoordinat>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BolaKoordinat>))
  "Converts a ROS message object to a list"
  (cl:list 'BolaKoordinat
